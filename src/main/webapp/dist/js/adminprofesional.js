...
function findprofesional() {
    ...
    $.each(result, function (i, item) {
        ...
        fill += '<tr>' + '<td>' + item.profesional.idPersona.nombre + ' ' + item.profesional.idPersona.apellido + '</td>' +
                ...
                '<td>' +
                '<button type="button" class="btn btn-block btn-outline-primary" value="' + item.profesional.id + '" onclick="suspenderprofesional(this.value)"  >' +
                accionsuspension +
                '</button>' +
                '<button type="button" class="btn btn-block btn-outline-danger" value="' + item.profesional.id + '" onclick="eliminarprofesional(this.value)" >' +
