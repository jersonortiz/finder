            ...
            .then(function (data) {
                ...
                $.each(data, function (i, item) {
                    fill += '<tr>' +
                            ...
                            '<td>' + item.costo + '</td>' +
                            '<td>' +
                            '<button type="button" class="btn btn-app" value="' + item.id + '" onclick="editar(this.value)">' +
                            '<i class="fas fa-pen"></i>' +
                            '</button>' +
                            '<button type="button" class="btn btn-app" value="' + item.id + '" onclick="eliminar(this.value)">' +
